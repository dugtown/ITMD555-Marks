...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public DatabaseHelper(Context context) {
        ...
        System.out.println("**** Data Helper constructor called");
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        onCreate(db);
        System.out.println("**** onUpgrade method called");
    }

    public boolean insertData(String name, String marks, String s) {
